 ...
 */
if let numberOfDays = daysInMonth["January"] {
    print("January has \(numberOfDays) days")
}
...
var combinations = ["Shapes": shapesArray, "Colors": colorsArray]
print(combinations)
 ...
 */
if let last = combinations["Colors"] {
    print(last.last!)
}
