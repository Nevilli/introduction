...
var tangle = Rectangle(width: 5, height: 2)
print(tangle.area)
/*:
...
var nuts = Height(heightInCentimeters: 28.2)
print(nuts.heightInInches)
var bolts = Height(heightInInches: 14)
print(bolts.heightInCentimeters)
