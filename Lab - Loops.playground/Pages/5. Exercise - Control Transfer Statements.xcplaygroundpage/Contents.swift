 ...
 */
var areas = ["Maryland": "Annapolis", "Alabama": "Montgomery", "Arkansas": "Little Rock"]
for (state, capital) in areas {
    print("The capital to \(state) is \(capital)")
    if state == "Maryland" {
